@forelse ($leads as $lead)
    <tr class="group hover:bg-gray-100 font-sans">
        <td class="px-6 py-2 text-[12.1px] font-normal text-gray-900">
            <a href="{{ route('leads.edit', $lead) }}" class="inline-block -mx-3 px-3 py-1 rounded-full transition-colors duration-200 group-hover:bg-gray-200 hover:underline">{{ $lead->name }}</a>
        </td>
