...
<div>
    ...
    <x-text-input id="postal_code" name="postal_code" type="text" class="mt-1 block w-full !text-[12.1px]" :value="old('postal_code', $listing->postal_code ?? '')" required autocomplete="postal-code" />
...
<div>
    ...
    <x-text-input id="address_line" name="address_line" type="text" class="mt-1 block w-full !text-[12.1px]" :value="old('address_line', $listing->address_line ?? '')" required autocomplete="address-line1" />
    <x-input-error class="mt-2" :messages="$errors->get('address_line')" />
</div>

<div>
    <x-input-label for="city" :value="__('City')" class="!text-[12.1px]" />
    <x-text-input id="city" name="city" type="text" class="mt-1 block w-full !text-[12.1px]" :value="old('city', $listing->city ?? '')" required autocomplete="address-level2" />
    <x-input-error class="mt-2" :messages="$errors->get('city')" />
</div>

<div>
    <x-input-label for="state_province" :value="__('State / Province')" class="!text-[12.1px]" />
    <x-text-input id="state_province" name="state_province" type="text" class="mt-1 block w-full !text-[12.1px]" :value="old('state_province', $listing->state_province ?? '')" required autocomplete="address-level1" />
